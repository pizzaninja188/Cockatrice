...
Implemented: 1674 full + 14 partial / 35530 cards across 343 sets.
...
- [ ] Sunderflock — 🟡 partial: Cost locking across mana abilities during casting payment requires an engine-owned casting transaction; current payment previews are read-only and recompute the cost on submission (#239).
- [x] Surly Farrier
- [ ] Swat Away
- [ ] Sygg's Command

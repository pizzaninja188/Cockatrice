...
Implemented: 1001 full + 18 partial / 35219 cards across 343 sets.
...
- [ ] Crimson Honor Guard
- [ ] Curse of Bounty
- [ ] Curse of Disturbance — 🟡 partial: the Zombie reward effect and each-attacking-opponent recipient needed to author the attacked-player trigger are deferred to issue #86
- [ ] Curse of Opulence — 🟡 partial: Gold token creation and the each-attacking-opponent recipient needed to author the attacked-player trigger are deferred to issue #86
- [ ] Curse of Verbosity
- [ ] Curse of Vitality
- [ ] Disrupt Decorum
- [ ] Dragon's Presence

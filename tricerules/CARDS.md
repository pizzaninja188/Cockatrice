...
Implemented: 855 full + 6 partial / 35219 cards across 343 sets.
...
- [x] Grizzly Bears
- [ ] Guardian Angel
- [ ] Healing Salve — 🟡 partial: only the 'prevent the next 3 damage to any target' mode; the 'target player gains 3 life' mode requires modal spell support (issue #19)
- [ ] Helm of Chatzuk
- [x] Hill Giant
- [ ] Holy Armor
- [x] Holy Strength
...
- [ ] Goblin Bully
- [x] Gorilla Warrior
- [ ] Gravedigger — 🟡 partial: ETB trigger is mandatory ("you may" not yet supported by trigger system)
- [ ] Hand of Death
- [ ] Harsh Justice
- [x] Highland Giant
- [ ] Horned Turtle
...
- [ ] Thought Scour
- [ ] Thought Vessel
- [ ] Thoughtseize — 🟡 partial: nonland restriction not enforced; you-lose-2-life not implemented
...
- [ ] Exiled Boggart
- [ ] Eyeblight's Ending — 🟡 partial: destroys any target creature; the 'non-Elf' targeting restriction is not enforced
- [ ] Eyes of the Wisent
- [ ] Facevaulter
- [ ] Faerie Harbinger
- [ ] Faerie Tauntings

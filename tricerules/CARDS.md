...
Implemented: 787 full + 9 partial / 34446 cards across 334 sets.
...
- [ ] Feedback
- [x] Fire Elemental
- [ ] Fireball — 🟡 partial: single target only; no damage division or per-target cost increase
- [ ] Firebreathing
- [ ] Flashfires
- [ ] Flight
- [ ] Fog
...
- [x] Grizzly Bears
- [ ] Guardian Angel
- [ ] Healing Salve — 🟡 partial: only the 'target player gains 3 life' mode; the 'prevent the next 3 damage to any target' mode is not implemented
- [ ] Helm of Chatzuk
- [x] Hill Giant
- [ ] Holy Armor
- [ ] Holy Strength
...
- [ ] Wooden Sphere
- [ ] Word of Command
- [ ] Wrath of God — 🟡 partial: regeneration not modeled ("can't be regenerated" has no effect yet)
- [ ] Zombie Master
...
- [ ] Energy Field
- [ ] Exhume
- [ ] Exploration — 🟡 partial: layer-5 continuous effect (extra land per turn) not yet implemented
- [ ] Expunge
- [ ] Faith Healer
- [ ] Falter
- [ ] Fault Line
...
- [ ] False Dawn
- [ ] Fervent Charge
- [ ] Fire // Ice — 🟡 partial: Fire deals its 2 damage to a single target; dividing among two targets is not modeled
- [ ] Flowstone Charger
- [ ] Foul Presence
- [ ] Fungal Shambler
- [ ] Gaea's Balance
...
- [ ] Burst of Speed
- [ ] Capricious Efreet
- [ ] Captain of the Watch — 🟡 partial: vigilance grant to other Soldiers you control not implemented (keyword-granting anthem, layer 6)
- [ ] Cemetery Reaper
- [x] Centaur Courser
- [x] Child of Night
- [ ] Convincing Mirage

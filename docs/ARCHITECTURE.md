...
| `GraveyardObjectMap` | **Servatrice**, every batch | `(player_id, oid)` → `Server_Card.id` | Graveyard targeting and public-zone actions, including generation-bound land plays. Fills `graveyardEngineOidToServerCardId`. |
